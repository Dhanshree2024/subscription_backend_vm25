...
export function NewUserInvitationEmail(
  { name, inviter, companyName, companyLogo, mailReply, inviteUrl ,verified}:
   { name: string; inviter: string; companyName: string; companyLogo?: string; mailReply: string; inviteUrl: string; verified?: boolean; }) {
 
 console.log("📩 Email Render Props:", {
  name, inviter, companyName, mailReply, inviteUrl, verified,
});
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            ...
            <Text style={styles.message}>You’ve been invited by {inviter} to join the {companyName} portal.</Text>
