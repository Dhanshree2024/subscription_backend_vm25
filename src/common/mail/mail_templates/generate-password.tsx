...
export function PasswordSetNotificationEmail({ name, companyName, companyLogo, mailReply, newPassword }: { name: string; companyName: string; companyLogo?: string; mailReply: string; newPassword: string  }) {
  return (
    <Html>
      <Head />
      <Preview>Your Password Has Been Set for {companyName} Account</Preview>
          ...
          <Container style={styles.container}>
            ...
            <Section style={styles.section}>
              ...
              <Text style={styles.successText}>
                A password has been successfully set for your {companyName} account.
              </Text>
              <Text style={styles.successText}>
                <strong>🔹 New Password:</strong> <span style={{ color: "red", fontWeight: "bold" }}>{newPassword}</span>
              </Text>
            ...
            <Section style={styles.footerSection}>
              ...
              <Text style={styles.disclaimer}>
                If this action was intentional, no further steps are needed. Otherwise, please reset your password immediately.
              </Text>
