...
export function AuthLoginVerificationEmail({ name, otp, companyName, companyLogo, mailReply }: { name: string; otp: string; companyName: string; companyLogo?: string; mailReply: string }) {
  return (
    <Html>
      <Head />
      <Preview>🔐 Login Verification Required for Your {companyName} Account</Preview>
        ...
        <Container style={styles.outerContainer}>
          <Container style={styles.container}>
            ...
            <Section style={styles.section}>
              ...
              <Text style={styles.otpText}>We have received a login request for your {companyName} account. For security purposes, please verify your identity by providing the following One-Time Password (OTP):</Text>
            ...
            <Section style={styles.footerSection}>
              <Hr style={styles.divider} />
              <Text style={styles.disclaimer}>If you did not initiate this login request, please disregard this message. Ensure the confidentiality of your OTP and do not share it with anyone.</Text>
